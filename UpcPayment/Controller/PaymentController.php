...
use Plugin\UpcPayment\Entity\PaymentStatus;
use Plugin\UpcPayment\Entity\CvsPaymentStatus;
use Plugin\UpcPayment\Repository\PaymentStatusRepository;
use Plugin\UpcPayment\Repository\CvsPaymentStatusRepository;
use Plugin\UpcPayment\Service\Method\Convenience;
...
class PaymentController extends AbstractController
{
    ...
    public function back(Request $request)
    {
        ...
        $Order->setUpcPaymentPaymentStatus($PaymentStatus);
     ...
     * 結果通知URLを受け取る.
     *
     * @Route("/upc_payment_receive_complete", name="upc_payment_receive_complete")
     */
     ...
     * 結果通知URLを受け取る(コンビニ決済).
     *
     * @Route("/upc_payment_receive_cvs_status", name="upc_payment_receive_cvs_status")
     */
        ...
        switch ($cvs_status) {
            ...
            case CvsPaymentStatus::FAILURE:
                ...
                if ($this->orderStateMachine->can($Order, $OrderStatus)) {
                    ...
                    $Order->setUpcPaymentCvsPaymentStatus($PaymentStatus);
                } else {
                    throw new BadRequestHttpException();
                }
    ...
    private function getOrderByNo($orderNo)
    {
        ...
        $Order = $this->orderRepository->findOneBy([
            ...
            'UpcPaymentPaymentStatus' => $outstandingPaymentStatus,
        ]);
