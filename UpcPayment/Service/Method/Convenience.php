...
namespace Plugin\UpcPayment\Service\Method;
...
class Convenience implements PaymentMethodInterface
{
    ...
    public function apply()
    {
        ...
        $this->Order->setUpcPaymentCvsPaymentStatus($PaymentStatus);
    ...
    public function checkout()
    {
        ...
        if (true) {
            ...
            $this->Order->setUpcPaymentCvsPaymentStatus($PaymentStatus); // 決済要求成功に変更
            ...
            $this->Order->setUpcPaymentCvsPaymentStatus($PaymentStatus); // 決済失敗
